define({ "api": [
  {
    ...
    "examples": [
      ...
      {
        "title": "Curl",
        "content": "curl \\\n  -X POST \\\n  http://localhost:3000/products \\\n  -H 'Content-Type: application/json' \\\n  -H 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoiQWRtaW4iLCJlbWFpbCI6ImFkbWluQGV4YW1wbGUuY29tIiwiYWRtaW4iOnRydWUsImV4cCI6MTYwNjIxNjYzNn0.BrPoxvbeFh9R4PSZ7MHO3iB5dNlgRjxUZ_l-2QQM6Zc' \\\n  -d '{\"name\":\"Item name\",\"description\":\"Item description\",\"active\":true,\"price\": 39.39}'",
        "type": "curl"
      }
    ],
    "version": "0.0.0",
  ...
  },
  {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "active",
            "description": "<p>activation of the product</p>"
          },
          {
            "group": "Parameter",
            "type": "Float",
    ...
    "examples": [
      {
        "title": "JSON",
        "content": "{\n    \"id\": \"fbe66211-b350-4647-ae32-29aca84a27b7\",\n    \"name\": \"Item UPDATE 1\",\n    \"description\": \"Item Description UPDATE 1\",\n    \"active\": true,\n    \"price\": 90.99\n}",
        "type": "json"
      },
      {
        "title": "Curl",
        "content": "curl \\\n  -X PUT \\\n  http://localhost:3000/products \\\n  -H 'Content-Type: application/json' \\\n  -H \"Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoiQWRtaW4iLCJlbWFpbCI6ImFkbWluQGV4YW1wbGUuY29tIiwiYWRtaW4iOnRydWUsImV4cCI6MTYwNjIxNjYzNn0.BrPoxvbeFh9R4PSZ7MHO3iB5dNlgRjxUZ_l-2QQM6Zc\" \\\n  -d '{\"id\": \"fbe66211-b350-4647-ae32-29aca84a27b7\",\"name\":\"Item UPDATE 1\",\"description\":\"Item Description UPDATE 1\",\"active\":true,\"price\":90.99}'",
        "type": "curl"
      }
    ],
    "version": "0.0.0",
